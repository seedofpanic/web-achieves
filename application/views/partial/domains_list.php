<div ng-controller="domainsController as dc" class="ui segment bottom attached">
    ...
    <table class="ui table">
        <tr class="domains ui link list" ng-repeat="domain in dc.domains">
            ...
            <td class="collapsing">
                <a class="ui button blue icon" href="?action=domain&domain_id={{domain.id}}"><i class="icon options"></i></a>
            </td>
            <td class="collapsing">
                <button class="ui button red icon" ng-class="{'loading': domain.loading}" ng-hide="domain.deleted>0" ng-click="dc.remove(domain)"><i class="icon delete"></i></button>
                <button class="ui button green icon" ng-class="{'loading': domain.loading}" ng-show="domain.deleted>0" ng-click="dc.remove(domain)"><i class="icon refresh"></i></button>
            </td>
        </tr>
    </table>
    <form class="ui form">
